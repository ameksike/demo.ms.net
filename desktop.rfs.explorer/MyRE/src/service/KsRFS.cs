...
public delegate void CallbackFtpList(string data);
namespace KsRFS.src.service
{
    delegate void CallbackOnList(DirInfo data);
    delegate void CallbackOnError(string data);
    ...
    class RFS
    {
        ...
        protected Driver getDriver() {
            string classname = "KsRFS.src.service.Driver" + this.protocol.ToUpper();
